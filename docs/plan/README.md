...
| [`plan-20260923.md`](plan-20260923.md) | 日期计划 | **已发布，完成门待 `DEP-FU-05`**（GitHub issues #25–#29：首次使用路径策略与开通、ImportRepo 增量推送与清理、合成 commit 签名头与帧；FU-01..FU-23 全部 done/complete，收口 **v0.40.12** / `4bf6cc2`，D 组绿（其中 v0.40.10 属 `plan-20260913`）；「计划完成门」按用户决定待本机测试环境 `DEP-FU-05` 解决后补跑；计划评审 Codex R22 PASS） |
