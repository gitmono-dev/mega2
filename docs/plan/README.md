...
| `plan-20260905.md` | 日期计划 | **TP-21 文档收口完成**（Trunk 直推 / `MonoWriteQueue`：TP-01..TP-21。设计事实源 = [`../refactoring/trunk-push.md`](../refactoring/trunk-push.md)。文档概览条目在 [`../refactoring/README.md`](../refactoring/README.md) **§5a**，不是仓库根 `README.md`） |
