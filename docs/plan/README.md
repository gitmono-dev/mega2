...
| `plan-20260908.md` | 日期计划 | **新建**（SP-01..SP-05；G-02 行为卡：SP-01=`auth_none`/none，SP-02=password-token；SP-04 cancelled→SP-01；SP-03 索引；SP-05 终态 release；Codex R18 PASS；每实现/release 卡 patch+1） |
