...
| [`plan-20260918.md`](plan-20260918.md) | 日期计划 | **执行中**（文件删移与 Tag 契约跟进。FT-01..07 已发布至 **v0.11.3** / `75ca189`：`is_directory` 文件删移、GET `/tags/list`、`mega_tag.path`、`(path, name)` 隔离、compose 黑盒。FT-08 重钉 Libra pin；FT-09 索引与 60917 DEFER 改指未收口。不新增 PT。不改 `../libra/**`） |
