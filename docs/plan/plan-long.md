...
| [`plan-20260912.md`](plan-20260912.md) | N/A（storage-only 提交后出站事件；非 Mega PT） | **进行中**（WH-01 配置表面） | `[storage_events]` 默认关闭、storage-only token/none 可启用、restart-required。无 webhook CRUD/outbox/retry。运输、运行时与来源适配见后续 WH 卡。 |
