...
pub use super::{
    ...
    bot_installations::Entity as BotInstallations, bot_keys::Entity as BotKeys,
    bot_tokens::Entity as BotTokens, bots::Entity as Bots, buck_session::Entity as BuckSession,
