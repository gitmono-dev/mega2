...
impl RelationTrait for Relation {
    fn def(&self) -> RelationDef {
        match self {
            Self::MegaIssue => Entity::belongs_to(crate::callisto::mega_issue::Entity)
                .from(Column::Link)
                .to(crate::callisto::mega_issue::Column::Link)
                .into(),
...
impl Related<crate::callisto::mega_issue::Entity> for Entity {
    fn to() -> RelationDef {
