...
impl TriggerRecord {
    pub fn from_db_model(model: crate::callisto::build_triggers::Model) -> Self {
        Self {
            id: model.id,
...
impl From<ListTriggersParams>
    for crate::jupiter::storage::build_trigger_storage::ListTriggersFilter
{
