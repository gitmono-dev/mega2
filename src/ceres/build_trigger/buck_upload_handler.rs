...
use crate::{
    ceres::{
        ...
        build_trigger::{
            BuckFileUploadPayload, BuildTrigger, BuildTriggerPayload, BuildTriggerType,
...
/// Handler for Buck file upload triggers.
pub struct BuckFileUploadHandler {
...
#[async_trait]
impl TriggerHandler for BuckFileUploadHandler {
    async fn handle(&self, context: &TriggerContext) -> Result<BuildTrigger, MegaError> {
        ...
        Ok(BuildTrigger {
            ...
            payload: BuildTriggerPayload::BuckFileUpload(BuckFileUploadPayload {
    ...
    fn trigger_type(&self) -> BuildTriggerType {
        BuildTriggerType::BuckFileUpload
    }
}
