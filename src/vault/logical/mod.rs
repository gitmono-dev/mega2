//! The `crate::vault::logical` is a low level module that defines 'backend' and relevant data
...
//! object and implement `crate::vault::logical::Backend` trait for it. Thus, this module can be
