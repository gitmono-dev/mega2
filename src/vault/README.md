# Vault Module - Vendored RustyVault

This directory contains vendored RustyVault code compiled directly as the
`crate::vault` module of monoengine. It is no longer a separate Cargo library
crate or path dependency.
...
The module exposes a single entry point: `RustyVault`.

```rust
use crate::vault::{RustyVault, config::Config, core::SealConfig, storage};
