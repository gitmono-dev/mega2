//! `crate::vault::modules` contains a set of real RustyVault modules. Each sub module needs to
//! implement the `crate::vault::modules::Module` trait defined here and then the module
