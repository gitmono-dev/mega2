//! The crate::vault::crypto module abstracts a set of generic cryptography methods. These methods
...
///
/// ~~~
/// use crate::vault::modules::crypto::{AES, AESKeySize, CipherMode, BlockCipher};
///
...
///
#[cfg_attr(any(), doc = "~~~")]
#[cfg_attr(not(any()), doc = "~~~ignore")]
/// use crate::vault::modules::crypto::{SM4, CipherMode, BlockCipher};
///
...
///
/// ~~~
/// use crate::vault::modules::crypto::{AES, AESKeySize, CipherMode, BlockCipher, AEADCipher};
///
/// let data = b"The best way to not feel hopeless is to get up and do something.".to_vec();
/// let key = b"\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0A\x0B\x0C\x0D\x0E\x0F".to_vec();
/// let iv = b"\x00\x01\x02\x03\x04\x05\x06\x07\x00\x01\x02\x03\x04\x05\x06\x07".to_vec();
...
#[cfg_attr(not(any()), doc = "~~~ignore")]
/// ~~~
/// use crate::vault::modules::crypto::{SM4, CipherMode, BlockCipher, AEADCipher};
///
/// let data: [&[u8]; 2] = [b"The best way to not feel hopeless ",
///                         b"is to get up and do something."];
/// let data2 = b"The best way to not feel hopeless is to get up and do something.";
