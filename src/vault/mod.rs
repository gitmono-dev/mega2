...
//!
//! The second working mode, which works as a typical Rust crate called `RustyVault`, allows Rust
...
//!
//! This is the official documentation of crate `RustyVault`, and it's mainly for developers.
...
/// RustyVault crate version.
///
/// This constant reflects the crate package version from Cargo.toml and is
/// useful for diagnostics and logging when embedding `RustyVault` into
/// applications.
pub const VERSION: &str = "0.2.2";

/// Main entry point for using the `RustyVault` crate programmatically.
///
