...
//! The `crate::vault::core` module implements several key functions that are
...
impl Core {
    ...
    /// Unseals the RustyVault once and immediately generates new unseal keys.
    ///
    ...
    /// using Shamir's Secret Sharing scheme. The generated keys can be used to unseal the RustyVault
    ...
    ///
    /// # Usage
    /// This method should only be called when the RustyVault is unsealed and a valid KEK exists.
