...
//! features that users need. All modules in RustyVault are managed by `crate::vault::module_manager`.
//!
...
//! organized in the form of a module of crate `RustyVault` in Rust language concept.
